...
public:
    ...
    void autocompleteRecUtil(TrieNode *curr, string &n_pre, vector<string> &op)
    {
        if (curr->isLeaf)
            op.push_back(n_pre);
    ...
    void autocomplete(string &prefix, vector<string> &op)
    {
        TrieNode *curr = this->root;
    ...
    void populateTrie(vector<string> &path_variable)
    {
